...
def grab_data(GCM,scen,sens,FT_group,var,first_year,last_year):
    ...
    if FT_group == '':
        ...
        ds_sens = xr.open_dataset(pathwayIN+'/output/netCDF/NHP/runs_'+GCM+'_'+
                                  scen+'_'+sens+'/'+FT_group+'/'+var+'_1960-2099_'+
                                  suffix+'.nc')        
...
def barplot_fuel_time(FT_group,sens,var1,var2,axis):
    ### Set up for loop
...
### Plot barplot
barplot_fuel_time('',sens,'cmass','cmass_wood',ax1)
barplot_fuel_time('Wet_forest',sens,'cmass','cmass_wood',ax3)
barplot_fuel_time('Mallee',sens,'cmass','cmass_wood',ax5)

barplot_fuel_time('',sens,'cmass_leaf','clitter',ax2)
barplot_fuel_time('Wet_forest',sens,'cmass_leaf','clitter',ax4)
barplot_fuel_time('Mallee',sens,'cmass_leaf','clitter',ax6)
...
fig.align_ylabels()
plt.savefig('figures/barplot_'+sens+'_cpool_fuel_group.pdf')
